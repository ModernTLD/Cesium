...
## Individual Contributor exclusive License Agreement including the Patent Pledge OPTION

Thank you for your interest in contributing to Cesium ("We" or "Us").

The purpose of this contributor agreement ("Agreement") is to clarify and document the rights granted by contributors to Us. To make this document effective, please follow the instructions at https://www.moderntld.com/contributing.
...
**"Contribution"** means any original work of authorship (software and/or documentation) including any modifications or additions to an existing work, Submitted by You to Us, in which You own the Copyright. If You do not own the Copyright in the entire work of authorship, please contact Us at hello@moderntld.com.
...
Date: 2017-04-22
Name: Jonah Aragon (ModernTLD); [@ModernTLD](https://github.com/ModernTLD)

### YOU

Please add the following information below as an addition to this document, with `I agree to this CLA` as the commit message in git.

```
Date: YYYY-MM-DD
Name: Full Name; GitHub Username
```

Date: 2017-04-22
Name: Jonah Aragon; [@JonahAragon](https://github.com/JonahAragon)
